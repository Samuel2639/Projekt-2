...
Original file is located at
    https://colab.research.google.com/drive/1vX3Rtz5emv01VBnBUr5MHLlNmdI3fZ6V
"""

print("Zdravím vás!")
print("-" * 30)
print("Vygeneroval jsem pro vás náhodné čtyřmístné číslo. Pojďme si zahrát Bulls and Cows.")
...
while True:
  ...
  if bulls == 4:
    print("Správně, uhodli jste správné číslo.")
    break
  else:
